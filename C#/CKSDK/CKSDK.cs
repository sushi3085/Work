...
namespace CKSDK
{
	...
	public enum emImageTransferMode
	{
	...
	public enum emCameraMediaType
	{
		...
		CAMERA_MEDIA_TYPE_COLOR_MASK =                     unchecked((int)0xFF000000),
	...
	public struct tDevLoadMode
	{
		...
		public uint MediaTypeMode;
		/** @brief @~chinese 帧速度 @~english Frame rate */
		public uint FrameSpeedMode;
	...
	public struct tResolutionRange
	{
		...
		public uint uBinAverageModeMask;
		/** @brief @~chinese 硬件重采样的掩码 @~english Hardware resampling mask */
		public uint uResampleMask;
	}
	...
	public struct tGammaContrastRange
	{
		/** @brief @~chinese 最小值 @~english Minimum value */
		public int iMin;
		/** @brief @~chinese 最大值 @~english Maximum value */
	...
	public struct tSdkIspCapacity
	{
		...
		public uint bForceUseDeviceIsp;
	...
	public struct tDeviceCfg
	{
		...
		public IntPtr pBayerDecAlmHdDesc;
	...
	public struct tDevInfo
	{
		...
		public ushort DeviceDrvID;
		/** @brief @~chinese 设备驱动版本ID @~english Device Driver Version ID */
		public ushort DeviceDrvVersionID;
	...
	public struct tSdkCameraCapbility
	{
		...
		public tDeviceCfg tDeviceCapbility;
		/** @brief @~chinese sensor能力级 @~english sensor level */
		public tSensorCfg tSensorCapbility;

	}

	/** @brief @~chinese 矩形位置 @~english Rectange position */
	public struct RECT
	{
		public long left;
		public long top;
	...
	//图像捕获的回调函数定义
	public delegate void CAMERA_SNAP_PROC(CameraHandle handle, IntPtr pFrameBuffer, ref stImageInfo pFrameInfo, IntPtr lpParam);
	//图像显示的回调函数
	public delegate void CAMERA_DISPLAY_PROC(CameraHandle handle, IntPtr hdc, ref DisplayWindow pDisplayWindow, IntPtr lpParam);


	static public class CKSDKAPI
	{
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraEnumerateDevice(out int pDeviceNum);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraGetEnumIndexInfo(int CameraIndex, out tDevEnumInfo pDevInfo);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraInit(out CameraHandle phCamera, int CameraIndex);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraInitEx(out CameraHandle phCamera, int CameraIndex, int iParamLoadMode, int emTeam);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraInitEx2(out CameraHandle phCamera, IntPtr pFriendlyName);
		static public CameraSdkStatus CameraInitEx2(out CameraHandle phCamera, string friendlyName)
		{
			IntPtr friendlyNamePtr = StringToPtr(friendlyName);
			CameraSdkStatus status = __CameraInitEx2(out phCamera, friendlyNamePtr);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraInitEx3(out CameraHandle phCamera, IntPtr pCameraSN);
		static public CameraSdkStatus CameraInitEx3(out CameraHandle phCamera, string cameraSN)
		{
			IntPtr cameraSnPtr = StringToPtr(cameraSN);
			CameraSdkStatus status = __CameraInitEx3(out phCamera, cameraSnPtr);
			Marshal.FreeHGlobal(cameraSnPtr);
			return status;
		}
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraUnInit(CameraHandle hCamera);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetCapability(CameraHandle hCamera, out tSdkCameraCapbility pCameraCap);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetCurDevInfo(CameraHandle hCamera, out tDevLoadInfo pDevInfo);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraGetRawImageBuffer(CameraHandle hCamera, out IntPtr phRawBuf, uint uTimes);
		 ...
		 *@see CameraGetImageInfo
		 */
		public delegate CameraSdkStatus pfnCameraReleaseFrameHandle(CameraHandle hCamera, IntPtr hRawBuf);
		 ...
		 */
		public delegate IntPtr pfnCameraGetImageInfo(CameraHandle hCamera, IntPtr hRawBuf, out stImageInfo pImgInfo);
		 ...
		 *@see CameraGetRawImageBuffer
		 */
		public delegate CameraSdkStatus pfnCameraGetImageTimestamp(CameraHandle hCamera, IntPtr hRawBuf, out ulong puTimestamp);
		 ...
		 *@param[in] hRawBuf    输入图像数据的缓冲区地址，不能为NULL，填入@link #CameraGetImageInfo @endlink函数的返回值。
		 ...
		 *@param[in] hRawBuf Enter the buffer address of the image data, which cannot be NULL.
		 *@param[out] pImgBuf The buffer address of the image output after processing by pImgBuf cannot be  NULL.  Fill in the return value of the @link #CameraGetImageInfo @endlink function.
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetOutImageBuffer(CameraHandle hCamera, ref stImageInfo pImgInfo, IntPtr hRawBuf, IntPtr pImgBuf);
		 ...
		 */
		public delegate IntPtr pfnCameraGetImageBufferEx(CameraHandle hCamera, out stImageInfo pImgInfo, uint uTimes);
		 ...
		 *@param[out] pImgInfo	  结构体，返回帧头信息
		 *@param[in] uTimes 抓取图像的超时时间。单位毫秒。在wTimes时间内还未获得图像，则该函数会返回超时信息。
		 *@return @link #__CK_ERRCODE__ 状态码@endlink
		 *@~english
		 *@brief Gets a frame of image data. The image obtained by this interface is the processed format. This format can be set via @link #CameraSetIspOutFormat @endlink
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetImageBufferEx1(CameraHandle hCamera, IntPtr pImageData, out stImageInfo pImgInfo, uint uTimes);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraGetImageBufferEx2(CameraHandle hCamera, IntPtr pImageData, out  stImageInfo pImgInfo, out ulong puTimeStamp, uint uTimes);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraResetTimestamp(CameraHandle hCamera);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetCallbackFunction(CameraHandle hCamera, CAMERA_SNAP_PROC pCallBack, IntPtr lpParam, out CAMERA_SNAP_PROC pCallbackOld);
		 ...
		 *@ return @link #__CK_ERRCODE__ status code @endlink
		*/
		public delegate CameraSdkStatus pfnCameraSetImageTransferMode(CameraHandle hCamera, int transferMode);
		...
		*@ return @link #__CK_ERRCODE__ status code @endlink
		*/
		public delegate CameraSdkStatus pfnCameraGetImageTransferMode(CameraHandle hCamera, out int pTransferMode);
		...
		*@ return @link #__CK_ERRCODE__ status code @endlink
		*/
		public delegate CameraSdkStatus pfnCameraRequestTransferImage(CameraHandle hCamera);
		 ...
		 *@see CameraPlay
		 */
		public delegate CameraSdkStatus pfnCameraPause(CameraHandle hCamera);
		 ...
		 *@see CameraPause
		 */
		public delegate CameraSdkStatus pfnCameraPlay(CameraHandle hCamera);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraDisplayInit(CameraHandle hCamera, IntPtr hWndDisplay);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetDisplayMode(CameraHandle hCamera, int iMode);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetDisplayScaleRadio(CameraHandle hCamera, int iRadio);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetDisplayOffset(CameraHandle hCamera, int iOffsetX, int iOffsetY);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetDisplaySize(CameraHandle hCamera, int iWidth, int iHeight);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetCrossLine(CameraHandle hCamera, int iLine, int x, int y, uint uColor, uint bVisible);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetCrossLine(CameraHandle hCamera, int iLine, out int px, out int py, out uint puColor, out uint pbVisible);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraImageOverlay(CameraHandle hCamera, IntPtr pImgBuf, ref stImageInfo pImgInfo);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraDrawText(IntPtr pImgBuf, ref stImageInfo pImgInfo,
				Char[] pFontFileName,
				uint FontWidth,
				uint FontHeight,
				Char[] pText,
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraDisplay(CameraHandle hCamera, IntPtr pImgBuf, ref stImageInfo pImgInfo);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetDisplayCallbackFun(CameraHandle hCamera, CAMERA_DISPLAY_PROC pCallBack, IntPtr lpParam, out CAMERA_DISPLAY_PROC pCallbackOld);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSnapToBuffer(CameraHandle hCamera, out IntPtr phBuf, out stImageInfo pImgInfo, out IntPtr ppImgBuf, uint uWaitTimeMs);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetResolutionForSnap(CameraHandle hCamera, ref tSdkImageResolution pImageResolution);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetResolutionForSnap(CameraHandle hCamera, out tSdkImageResolution pImageResolution);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetAeState(CameraHandle hCamera, uint bAeState);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetAeState(CameraHandle hCamera, out uint pAeState);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetAeTarget(CameraHandle hCamera, ushort AeTarget);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetAeTarget(CameraHandle hCamera, out ushort pAeTarget);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraSetAnalogGain(CameraHandle hCamera, uint uAnalogGain);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetAnalogGain(CameraHandle hCamera, out uint puAnalogGain);
		 ...
		 *@warning This function must be in manual mode to take effect.
		 */
		public delegate CameraSdkStatus pfnCameraSetExposureTime(CameraHandle hCamera, double dExposureTime);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetExposureTime(CameraHandle hCamera, out double pdExposureTime);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetAeWindow(CameraHandle hCamera, uint dwLeft, uint dwTop, uint dwWidth, uint dwHeight);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetAeWindow(CameraHandle hCamera, out uint pdwLeft, out uint pdwTop, out uint pdwWidth, out uint pdwHeight);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetAeWinVisible(CameraHandle hCamera, uint bDisplayEn);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetAeWinVisible(CameraHandle hCamera, out uint pbDisplayEn);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetAntiFlick(CameraHandle hCamera, uint bEnable);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetAntiFlick(CameraHandle hCamera, out uint pbEnable);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetLightFrequency(CameraHandle hCamera, int iFrequencySel);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetLightFrequency(CameraHandle hCamera, out int piFrequencySel);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetExposureLineTime(CameraHandle hCamera, out double pExposureLineTime);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetAeExposureMode(CameraHandle hCamera, int iMode);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetAeExposureMode(CameraHandle hCamera, out int piMode);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetAeExposureRange(CameraHandle hCamera, double dMinExposureTime, double dMaxExposureTime);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetAeExposureRange(CameraHandle hCamera, out double pdMinExposureTime, out double pdMaxExposureTime);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetAeAnalogGainRange(CameraHandle hCamera, int iMinAnalogGain, int iMaxAnalogGain);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetAeAnalogGainRange(CameraHandle hCamera, out int iMinAnalogGain, out int iMaxAnalogGain);
		 ...
		 *@warning This function must be in manual mode to take effect.
		 */
		public delegate CameraSdkStatus pfnCameraSetGain(CameraHandle hCamera, ushort DGainR, ushort DGainG, ushort DGainB);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetGain(CameraHandle hCamera, out ushort pDGainR, out ushort pDGainG, out ushort pDGainB);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetWbMode(CameraHandle hCamera, uint bAuto);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetWbMode(CameraHandle hCamera, out uint pbAuto);
		 ...
		 *@warning This function must be in manual mode to take effect.
		 */
		public delegate CameraSdkStatus pfnCameraSetOnceWB(CameraHandle hCamera);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetWbWindow(CameraHandle hCamera, uint dwLeft, uint dwTop, uint dwWidth, uint dwHeight);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetWbWindow(CameraHandle hCamera, out uint pdwLeft, out uint pdwTop, out uint pdwWidth, out uint pdwHeight);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetWbWinVisible(CameraHandle hCamera, uint bDisplayEn);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetWbWinVisible(CameraHandle hCamera, out uint pDisplayEn);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetLutMode(CameraHandle hCamera, int emLutMode);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetLutMode(CameraHandle hCamera, out int pemLutMode);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetGamma(CameraHandle hCamera, int iGamma);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetGamma(CameraHandle hCamera, out int piGamma);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSetContrastLut(CameraHandle hCamera, int iContrast);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraGetContrastLut(CameraHandle hCamera, out int piContrast);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraSelectLutPreset(CameraHandle hCamera, int iSel);
		 ...
		 *@return @link #__CK_ERRCODE__ Status Code @endlink
		 */
		public delegate CameraSdkStatus pfnCameraGetLutPresetSel(CameraHandle hCamera, out int piSel);
		 ...
		 */
		public delegate CameraSdkStatus pfnCameraSetCustomLut(CameraHandle hCamera, int iChannel, IntPtr pLut);
static public CameraSdkStatus CameraSetCustomLut(CameraHandle hCamera, int iChannel, short[] pLut)
{
	IntPtr lutPtr = Marshal.AllocHGlobal(4096 * sizeof(short));
	Marshal.Copy(pLut, 0, lutPtr, pLut.Length);
	CameraSdkStatus status = __CameraSetCustomLut(hCamera, iChannel, lutPtr);
	Marshal.FreeHGlobal(lutPtr);
	return status;
}
 ...
 */
public delegate CameraSdkStatus pfnCameraGetCustomLut(CameraHandle hCamera, int iChannel, IntPtr pLut);
static public CameraSdkStatus CameraGetCustomLut(CameraHandle hCamera, int iChannel, out short[] pLut)
{
	IntPtr lutPtr = Marshal.AllocHGlobal(4096 * sizeof(short));
	CameraSdkStatus status = __CameraSetCustomLut(hCamera, iChannel, lutPtr);
	pLut = new short[4096];
	Marshal.Copy(lutPtr, pLut, 0, pLut.Length);
	Marshal.FreeHGlobal(lutPtr);
	return status;
}
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetCurrentLut(CameraHandle hCamera, int iChannel, IntPtr pLut);
static public CameraSdkStatus CameraGetCurrentLut(CameraHandle hCamera, int iChannel, out short[] pLut)
{
	IntPtr lutPtr = Marshal.AllocHGlobal(4096 * sizeof(short));
	CameraSdkStatus status = __CameraGetCurrentLut(hCamera, iChannel, lutPtr);
	pLut = new short[4096];
	Marshal.Copy(lutPtr, pLut, 0, pLut.Length);
	Marshal.FreeHGlobal(lutPtr);
	return status;
 ...
 */
public delegate CameraSdkStatus pfnCameraSetSharpness(CameraHandle hCamera, int iSharpness);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetSharpness(CameraHandle hCamera, out int piSharpness);
 ...
 */
public delegate CameraSdkStatus pfnCameraSetSaturation(CameraHandle hCamera, int iSaturation);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetSaturation(CameraHandle hCamera, out int piSaturation);
 ...
 */
public delegate CameraSdkStatus pfnCameraSetContrast(CameraHandle hCamera, int iContrast);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetContrast(CameraHandle hCamera, out int piContrast);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetFrameTime(CameraHandle hCamera, out double pdFrameTime);
 ...
 *@note 通过 CameraSetFrameSpeed 函数，可以动态设置相机的输出帧率。
 ...
 叧支持 2 个速度模式，有些支持 4 个，具体支持模式的数量，可以通
 ...
 *@note The camera's output frame rate can be dynamically set via the CameraSetFrameSpeed ??function.
 ...
 Number.
 */
public delegate CameraSdkStatus pfnCameraSetFrameSpeed(CameraHandle hCamera, int iFrameSpeed);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetFrameSpeed(CameraHandle hCamera, out int piFrameSpeed);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetResolution(CameraHandle hCamera, int iResolutionIndex);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetResolution(CameraHandle hCamera, out int piResolutionIndex);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetResolutionEx(CameraHandle hCamera, ref tSdkImageResolution pImageResolution);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetResolutionEx(CameraHandle hCamera, int iResolution, out tSdkImageResolution pImageResolution);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetCurResolution(CameraHandle hCamera, out tSdkImageResolution pImageResolution);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetOutImageSize(CameraHandle hCamera, out uint pWidth, out uint pHeight);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetBayerAlgMode(CameraHandle hCamera, int iAlgMode);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetBayerAlgThreshold(CameraHandle hCamera, int iAlgMode);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetBayerAlgMode(CameraHandle hCamera, out int piAlgMode);
...
*/
public delegate CameraSdkStatus pfnCameraSetIspOutFormat(CameraHandle hCamera, emCameraMediaType iFormat);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetIspOutFormat(CameraHandle hCamera, out int piFormat);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetFrameStatistic(CameraHandle hCamera, out FrameStatistic psFrameStatistic);
 ...
 * Image data is saved as BMP. If the RAW data is saved, use the @link #CameraGetRawImageBuffer @endlink function and the @link #CameraGetImageInfo @endlink function.
 RAW data buffer.
 */
public delegate CameraSdkStatus pfnCameraSaveImage(CameraHandle hCamera, IntPtr lpszFileName, IntPtr pImgBuf, ref stImageInfo pImgInfo, uint byFileType, byte byQuality);
static public CameraSdkStatus CameraSaveImage(CameraHandle hCamera, string lpszFileName, IntPtr pImgBuf, ref stImageInfo pImgInfo, uint byFileType, byte byQuality)
{
	IntPtr lpszFileNamePtr = StringToPtr(lpszFileName);
	CameraSdkStatus status = __CameraSaveImage(hCamera, lpszFileNamePtr, pImgBuf, ref pImgInfo, byFileType, byQuality);
	Marshal.FreeHGlobal(lpszFileNamePtr);
	return status;
}
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetMirror(CameraHandle hCamera, int iDir, uint bEnable);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetMirror(CameraHandle hCamera, int iDir, out uint pbEnable);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetMonochrome(CameraHandle hCamera, uint bEnable);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetMonochrome(CameraHandle hCamera, out uint pbEnable);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetBlackLevel(CameraHandle hCamera, int iBlackLevel);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetBlackLevel(CameraHandle hCamera, out int piBlackLevel);
 ...
 */
public delegate CameraSdkStatus pfnCameraSetSensorOutPixelFormat(CameraHandle hCamera, uint iFormat);
 ...
 *@see CameraGetCapability
 */
public delegate CameraSdkStatus pfnCameraGetSensorOutPixelFormat(CameraHandle hCamera, out uint piFormat);
 ...
 *@see CameraSetInputIOMode
 */
public delegate CameraSdkStatus pfnCameraSetTriggerMode(CameraHandle hCamera, int iTriggerModeSel);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetTriggerMode(CameraHandle hCamera, out int piTriggerModeSel);
 ...
 *@see CameraSetTriggerDelayTime
 */
public delegate CameraSdkStatus pfnCameraSoftTrigger(CameraHandle hCamera);
 ...
 *@see CameraSoftTrigger
 */
public delegate CameraSdkStatus pfnCameraSetTriggerFrameCount(CameraHandle hCamera, int frameCount);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetTriggerFrameCount(CameraHandle hCamera, out int pFrameCount);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetTriggerDelayTime(CameraHandle hCamera, uint delayTimeUs);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetTriggerDelayTime(CameraHandle hCamera, out uint pDelayTimeUs);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetTriggerJitterTime(CameraHandle hCamera, int inputIOIndex, uint jitterTimeUs);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetTriggerJitterTime(CameraHandle hCamera, int inputIOIndex, out uint pJitterTimeUs);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetTriggerSignalType(CameraHandle hCamera, int inputIOIndex, int type);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetTriggerSignalType(CameraHandle hCamera, int inputIOIndex, out int pType);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetStrobeMode(CameraHandle hCamera, int outputIOIndex, int mode);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetStrobeMode(CameraHandle hCamera, int outputIOIndex, out int pMode);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetStrobeDelayTime(CameraHandle hCamera, int outputIOIndex, uint delayTimeUs);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetStrobeDelayTime(CameraHandle hCamera, int outputIOIndex, out uint pDevlayTimeUs);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetStrobePulseWidth(CameraHandle hCamera, int outputIOIndex, uint pulseWidth);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetStrobePulseWidth(CameraHandle hCamera, int outputIOIndex, out uint pPulseWidth);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetStrobePolarity(CameraHandle hCamera, int outputIOIndex, int polarity);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetStrobePolarity(CameraHandle hCamera, int outputIOIndex, out int pPolarity);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetOutputIOMode(CameraHandle hCamera, int outputIOIndex, int mode);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetOutputIOMode(CameraHandle hCamera, int outputIOIndex, out int pMode);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetInputIOMode(CameraHandle hCamera, int inputIOIndex, int mode);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetInputIOMode(CameraHandle hCamera, int inputIOIndex, out int pMode);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetOutputIOState(CameraHandle hCamera, int outputIOIndex, int state);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetOutputIOState(CameraHandle hCamera, int outputIOIndex, out int pState);
 ...
 *@param[in] PWM high time, unit (us), less than the value of cycle
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetOutputIOPWM(CameraHandle hCamera, int outputIOIndex, uint cycle, uint duty);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetOutputIOPWM(CameraHandle hCamera, int outputIOIndex, out int pCycle, out int pDuty);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetInputIOState(CameraHandle hCamera, int inputIOIndex, out int pState);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetParameterMode(CameraHandle hCamera, int iMode);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetParameterMode(CameraHandle hCamera, out int piMode);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSaveParameter(CameraHandle hCamera, int iTeam);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSaveParameterToFile(CameraHandle hCamera, IntPtr sFileName);
static public CameraSdkStatus CameraSaveParameterToFile(CameraHandle hCamera, string sFileName)
{
	IntPtr fileNamePtr = StringToPtr(sFileName);
	CameraSdkStatus status = __CameraSaveParameterToFile(hCamera, fileNamePtr);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraReadParameterFromFile(CameraHandle hCamera, IntPtr sFileName);
static public CameraSdkStatus CameraReadParameterFromFile(CameraHandle hCamera, string sFileName)
{
	IntPtr fileNamePtr = StringToPtr(sFileName);
	CameraSdkStatus status = __CameraReadParameterFromFile(hCamera, fileNamePtr);
	Marshal.FreeHGlobal(fileNamePtr);
	return status;
}
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraLoadParameter(CameraHandle hCamera, int iTeam);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetCurrentParameterGroup(CameraHandle hCamera, out int piTeam);
 ...
 */
public delegate CameraSdkStatus pfnCameraWriteSN(CameraHandle hCamera, IntPtr pbySN, int iLevel);
static public CameraSdkStatus CameraWriteSN(CameraHandle hCamera, string pbySN, int iLevel)
{
	IntPtr snPtr = StringToPtr(pbySN);
	CameraSdkStatus status = __CameraWriteSN(hCamera, snPtr, iLevel);
 ...
 *@param[in] iLevel     要读取的序列号级别。只能是1和2。
 *@return @link #__CK_ERRCODE__ 状态码@endlink
 *@see CameraWriteSN
 *@~english
 ...
 *@param[in] iLevel The serial number level to be read. Can only be 1 and 2.
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 *@see CameraWriteSN
 */
public delegate CameraSdkStatus pfnCameraReadSN(CameraHandle hCamera, IntPtr pbySN, int iLevel);
static public CameraSdkStatus CameraReadSN(CameraHandle hCamera, out string sn, int iLevel)
{
	sn = "";
	IntPtr snPtr = Marshal.AllocHGlobal(128);
	CameraSdkStatus status = __CameraReadSN(hCamera, snPtr, iLevel);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSaveUserData(CameraHandle hCamera, uint uStartAddr, IntPtr pbData, int iLen);
static public CameraSdkStatus CameraSaveUserData(CameraHandle hCamera, uint uStartAddr, Byte[] pbData)
{
	IntPtr dataPtr = Marshal.AllocHGlobal(pbData.Length * sizeof(Byte));
	Marshal.Copy(pbData, 0, dataPtr, pbData.Length);
	CameraSdkStatus status = __CameraSaveUserData(hCamera, uStartAddr, dataPtr, pbData.Length);
 ...
 */
public delegate CameraSdkStatus pfnCameraLoadUserData(CameraHandle hCamera, uint uStartAddr, IntPtr pbData, int iLen);
static public CameraSdkStatus CameraLoadUserData(CameraHandle hCamera, uint uStartAddr, out Byte[] pbData, int iLen)
{
	IntPtr dataPtr = Marshal.AllocHGlobal(iLen * sizeof(Byte));
	CameraSdkStatus status = __CameraLoadUserData(hCamera, uStartAddr, dataPtr, iLen);
	pbData = new Byte[iLen];
	Marshal.Copy(dataPtr, pbData, 0, iLen);
	Marshal.FreeHGlobal(dataPtr);
	return status;
}
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetFriendlyName(CameraHandle hCamera, IntPtr pName);
static public CameraSdkStatus CameraGetFiendlyName(CameraHandle hCamera, out string friendlyName)
{
	friendlyName = "";
	IntPtr friendlyNamePtr = Marshal.AllocHGlobal(128);
	CameraSdkStatus status = __CameraGetFriendlyName(hCamera, friendlyNamePtr);
	if (status == CameraSdkStatus.CAMERA_STATUS_SUCCESS)
		friendlyName = Marshal.PtrToStringAnsi(friendlyNamePtr);
	Marshal.FreeHGlobal(friendlyNamePtr);
	return status;
}
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSetFriendlyName(CameraHandle hCamera, IntPtr pName);
static public CameraSdkStatus CameraSetFriendlyName(CameraHandle hCamera, string friendlyName)
{
	IntPtr friendlyNamePtr = StringToPtr(friendlyName);
	CameraSdkStatus status = __CameraSetFriendlyName(hCamera, friendlyNamePtr);
	Marshal.FreeHGlobal(friendlyNamePtr);
	return status;
}
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraSdkGetVersionString(IntPtr pVersionString);
static public CameraSdkStatus CameraSdkGetVersionString(CameraHandle hCamera, out string version)
{
	version = "";
	IntPtr versionPtr = Marshal.AllocHGlobal(128);
	CameraSdkStatus status = __CameraSdkGetVersionString(versionPtr);
	if (status == CameraSdkStatus.CAMERA_STATUS_SUCCESS)
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraCheckFwUpdate(CameraHandle hCamera, out uint pNeedUpdate);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetFirmwareVision(CameraHandle hCamera, IntPtr pVersion);
static public CameraSdkStatus CameraGetFirmwareVision(CameraHandle hCamera, out string version)
{
	version = null;

	IntPtr versionPtr = Marshal.AllocHGlobal(128);
	CameraSdkStatus status = __CameraGetFirmwareVision(hCamera, versionPtr);
	if (status == CameraSdkStatus.CAMERA_STATUS_SUCCESS)
		version = Marshal.PtrToStringAnsi(versionPtr);
	Marshal.FreeHGlobal(versionPtr);
	return status;
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetDeviceType(CameraHandle hCamera, out uint pDeviceID);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraGetInerfaceVersion(CameraHandle hCamera, IntPtr pVersion);
static public CameraSdkStatus CameraGetInerfaceVersion(CameraHandle hCamera, out string version)
{
	version = null;

	IntPtr versionPtr = Marshal.AllocHGlobal(128);
	CameraSdkStatus status = __CameraGetInerfaceVersion(hCamera, versionPtr);
	if (status == CameraSdkStatus.CAMERA_STATUS_SUCCESS)
		version = Marshal.PtrToStringAnsi(versionPtr);
	Marshal.FreeHGlobal(versionPtr);
	return status;
 ...
 *@see CameraSetActivePage
 */
public delegate CameraSdkStatus pfnCameraShowSettingPage(CameraHandle hCamera, uint bShow);
 ...
 *@see CameraShowSettingPage
 */
public delegate CameraSdkStatus pfnCameraSetActivePage(CameraHandle hCamera, emSettingPage lActivePage, int iDefault);
 ...
 *@return @link #__CK_ERRCODE__ Status Code @endlink
 */
public delegate CameraSdkStatus pfnCameraCreateSettingPageEx(CameraHandle hCamera);
...
public delegate CameraSdkStatus pfnCameraCustomizeResolution(
		...
		out tSdkImageResolution pImageCustom
		);
 ...
 *@see CameraGigeSetIp
 */
public delegate CameraSdkStatus pfnCameraGigeGetIp(IntPtr pCameraSN, out tGigeNetworkInfo pNetworkInfo);
static public CameraSdkStatus CameraGigeGetIp(string cameraSN, out tGigeNetworkInfo pNetworkInfo)
{
	IntPtr cameraSNPtr = StringToPtr(cameraSN);
	CameraSdkStatus status = __CameraGigeGetIp(cameraSNPtr, out pNetworkInfo);
	Marshal.FreeHGlobal(cameraSNPtr);
	return status;
}
 ...
 *@see CameraGigeSetIp
 */
public delegate CameraSdkStatus pfnCameraGigeSetIp(IntPtr pCameraSN, ref tGigeNetworkInfo pNetworkInfo);
static public CameraSdkStatus CameraGigeSetIp(string cameraSN, ref tGigeNetworkInfo pNetworkInfo)
{
	IntPtr cameraSNPtr = StringToPtr(cameraSN);
	CameraSdkStatus status = __CameraGigeSetIp(cameraSNPtr, ref pNetworkInfo);
	Marshal.FreeHGlobal(cameraSNPtr);
	return status;
}
 ...
 *@see CameraGigeSetTransPacketSize
 */
public delegate CameraSdkStatus pfnCameraGigeGetTransPacketSize(CameraHandle hCamera, out uint pPacketSize);
 ...
 *@see CameraGigeGetTransPacketSize
 */
public delegate CameraSdkStatus pfnCameraGigeSetTransPacketSize(CameraHandle hCamera, uint packetSize);

////////////////////////////////////////////////////////////////////////////////////////////////
public static pfnCameraEnumerateDevice CameraEnumerateDevice;
public static pfnCameraInit CameraInit;
public static pfnCameraInitEx CameraInitEx;
public static pfnCameraInitEx2 __CameraInitEx2;
public static pfnCameraInitEx3 __CameraInitEx3;
public static pfnCameraUnInit CameraUnInit;
public static pfnCameraGetEnumIndexInfo CameraGetEnumIndexInfo;
public static pfnCameraGetCapability CameraGetCapability;
public static pfnCameraDisplayInit CameraDisplayInit;
public static pfnCameraSetDisplayMode CameraSetDisplayMode;
public static pfnCameraSetDisplayScaleRadio CameraSetDisplayScaleRadio;
...
public static pfnCameraDisplay CameraDisplay;
public static pfnCameraSetDisplayCallbackFun CameraSetDisplayCallbackFun;
public static pfnCameraGetRawImageBuffer CameraGetRawImageBuffer;
public static pfnCameraGetImageInfo CameraGetImageInfo;
public static pfnCameraGetImageTimestamp CameraGetImageTimestamp;
public static pfnCameraReleaseFrameHandle CameraReleaseFrameHandle;
public static pfnCameraGetOutImageBuffer CameraGetOutImageBuffer;
public static pfnCameraGetImageBufferEx CameraGetImageBufferEx;
public static pfnCameraGetImageBufferEx1 CameraGetImageBufferEx1;
public static pfnCameraGetImageBufferEx2 CameraGetImageBufferEx2;
public static pfnCameraResetTimestamp CameraResetTimestamp;
public static pfnCameraSetCallbackFunction CameraSetCallbackFunction;
public static pfnCameraSetImageTransferMode CameraSetImageTransferMode;
public static pfnCameraGetImageTransferMode CameraGetImageTransferMode;
public static pfnCameraRequestTransferImage CameraRequestTransferImage;
...
public static pfnCameraGetAeWinVisible CameraGetAeWinVisible;
...
public static pfnCameraSetAeExposureMode CameraSetAeExposureMode;
public static pfnCameraGetAeExposureMode CameraGetAeExposureMode;
...
public static pfnCameraGetWbWinVisible CameraGetWbWinVisible;
...
public static pfnCameraSetCustomLut __CameraSetCustomLut;
public static pfnCameraGetCustomLut __CameraGetCustomLut;
...
public static pfnCameraGetFrameTime CameraGetFrameTime;
public static pfnCameraSetFrameSpeed CameraSetFrameSpeed;
public static pfnCameraGetFrameSpeed CameraGetFrameSpeed;
public static pfnCameraSetResolution CameraSetResolution;
public static pfnCameraGetResolution CameraGetResolution;
public static pfnCameraSetResolutionEx CameraSetResolutionEx;
public static pfnCameraGetResolutionEx CameraGetResolutionEx;
public static pfnCameraGetCurResolution CameraGetCurResolution;
public static pfnCameraGetOutImageSize CameraGetOutImageSize;
public static pfnCameraSetBayerAlgMode CameraSetBayerAlgMode;
public static pfnCameraSetBayerAlgThreshold CameraSetBayerAlgThreshold;
public static pfnCameraGetBayerAlgMode CameraGetBayerAlgMode;
...
public static pfnCameraSaveImage __CameraSaveImage;
...
public static pfnCameraSetSensorOutPixelFormat CameraSetSensorOutPixelFormat;
public static pfnCameraGetSensorOutPixelFormat CameraGetSensorOutPixelFormat;
...
public static pfnCameraSaveParameterToFile __CameraSaveParameterToFile;
public static pfnCameraReadParameterFromFile __CameraReadParameterFromFile;
...
public static pfnCameraWriteSN __CameraWriteSN;
public static pfnCameraReadSN __CameraReadSN;
public static pfnCameraSaveUserData __CameraSaveUserData;
public static pfnCameraLoadUserData __CameraLoadUserData;
public static pfnCameraGetFriendlyName __CameraGetFriendlyName;
public static pfnCameraSetFriendlyName __CameraSetFriendlyName;
public static pfnCameraSdkGetVersionString __CameraSdkGetVersionString;
public static pfnCameraCheckFwUpdate CameraCheckFwUpdate;
public static pfnCameraGetFirmwareVision __CameraGetFirmwareVision;
public static pfnCameraGetDeviceType CameraGetDeviceType;
public static pfnCameraGetInerfaceVersion __CameraGetInerfaceVersion;
public static pfnCameraGetCurDevInfo CameraGetCurDevInfo;
public static pfnCameraShowSettingPage CameraShowSettingPage;
public static pfnCameraSetActivePage CameraSetActivePage;
public static pfnCameraCreateSettingPageEx CameraCreateSettingPageEx;
...
public static pfnCameraSetTriggerFrameCount CameraSetTriggerFrameCount;
public static pfnCameraGetTriggerFrameCount CameraGetTriggerFrameCount;
...
public static pfnCameraSetTriggerJitterTime CameraSetTriggerJitterTime;
public static pfnCameraGetTriggerJitterTime CameraGetTriggerJitterTime;
public static pfnCameraSetTriggerSignalType CameraSetTriggerSignalType;
public static pfnCameraGetTriggerSignalType CameraGetTriggerSignalType;
...
public static pfnCameraSetContrastLut __CameraSetContrastLut;
public static pfnCameraGetContrastLut __CameraGetContrastLut;
public static pfnCameraGetCurrentLut __CameraGetCurrentLut;
...
public static pfnCameraSetOutputIOState CameraSetOutputIOState;
public static pfnCameraGetOutputIOState CameraGetOutputIOState;
public static pfnCameraSetOutputIOPWM CameraSetOutputIOPWM;
public static pfnCameraGetOutputIOPWM CameraGetOutputIOPWM;
public static pfnCameraGigeGetIp __CameraGigeGetIp;
public static pfnCameraGigeSetIp __CameraGigeSetIp;
...
static private IntPtr StringToPtr(string strText)
{
	IntPtr ptr = Marshal.AllocHGlobal(128);

	Encoding utf8 = Encoding.UTF8;
	Encoding unicode = Encoding.Unicode;
	byte[] text_unicode = unicode.GetBytes(strText + "\0");
	byte[] text_utf8 = Encoding.Convert(unicode, utf8, text_unicode);
	Marshal.Copy(text_utf8, 0, ptr, text_utf8.Length);

	return ptr;
}

static public string CharArrayToString(char[] srcText)
{
	Encoding utf8 = Encoding.UTF8;
	Encoding unicode = Encoding.Unicode;

	byte[] text_utf8 = utf8.GetBytes(srcText);
	byte[] text_unicode = Encoding.Convert(utf8, unicode, text_utf8);
	string text = unicode.GetString(text_unicode);
...
static CKSDKAPI()
{
	IntPtr hSdkDll;
	if (IntPtr.Size == 8)
		hSdkDll = LoadLibrary("CKCameraDLL_X64.dll");
	else
		hSdkDll = LoadLibrary("CKCameraDLL.dll");

	CameraEnumerateDevice = (pfnCameraEnumerateDevice)GetFunctionAddress(hSdkDll, "CameraEnumerateDevice", typeof(pfnCameraEnumerateDevice));
	...
	__CameraInitEx2 = (pfnCameraInitEx2)GetFunctionAddress(hSdkDll, "CameraInitEx2", typeof(pfnCameraInitEx2));
	__CameraInitEx3 = (pfnCameraInitEx3)GetFunctionAddress(hSdkDll, "CameraInitEx3", typeof(pfnCameraInitEx3));
	CameraUnInit = (pfnCameraUnInit)GetFunctionAddress(hSdkDll, "CameraUnInit", typeof(pfnCameraUnInit));
	CameraGetEnumIndexInfo = (pfnCameraGetEnumIndexInfo)GetFunctionAddress(hSdkDll, "CameraGetEnumIndexInfo", typeof(pfnCameraGetEnumIndexInfo));
	CameraGetCapability = (pfnCameraGetCapability)GetFunctionAddress(hSdkDll, "CameraGetCapability", typeof(pfnCameraGetCapability));
	...
	CameraSetDisplayScaleRadio = (pfnCameraSetDisplayScaleRadio)GetFunctionAddress(hSdkDll, "CameraSetDisplayScaleRadio", typeof(pfnCameraSetDisplayScaleRadio));
	...
	CameraDisplay = (pfnCameraDisplay)GetFunctionAddress(hSdkDll, "CameraDisplay", typeof(pfnCameraDisplay));
	CameraSetDisplayCallbackFun = (pfnCameraSetDisplayCallbackFun)GetFunctionAddress(hSdkDll, "CameraSetDisplayCallbackFun", typeof(pfnCameraSetDisplayCallbackFun));
	CameraGetRawImageBuffer = (pfnCameraGetRawImageBuffer)GetFunctionAddress(hSdkDll, "CameraGetRawImageBuffer", typeof(pfnCameraGetRawImageBuffer));
	CameraGetImageInfo = (pfnCameraGetImageInfo)GetFunctionAddress(hSdkDll, "CameraGetImageInfo", typeof(pfnCameraGetImageInfo));
	CameraGetImageTimestamp = (pfnCameraGetImageTimestamp)GetFunctionAddress(hSdkDll, "CameraGetImageTimestamp", typeof(pfnCameraGetImageTimestamp));
	CameraReleaseFrameHandle = (pfnCameraReleaseFrameHandle)GetFunctionAddress(hSdkDll, "CameraReleaseFrameHandle", typeof(pfnCameraReleaseFrameHandle));
	CameraGetOutImageBuffer = (pfnCameraGetOutImageBuffer)GetFunctionAddress(hSdkDll, "CameraGetOutImageBuffer", typeof(pfnCameraGetOutImageBuffer));
	...
	CameraGetImageBufferEx1 = (pfnCameraGetImageBufferEx1)GetFunctionAddress(hSdkDll, "CameraGetImageBufferEx1", typeof(pfnCameraGetImageBufferEx1));
	CameraGetImageBufferEx2 = (pfnCameraGetImageBufferEx2)GetFunctionAddress(hSdkDll, "CameraGetImageBufferEx2", typeof(pfnCameraGetImageBufferEx2));
	CameraSetImageTransferMode = (pfnCameraSetImageTransferMode)GetFunctionAddress(hSdkDll, "CameraSetImageTransferMode", typeof(pfnCameraSetImageTransferMode));
	CameraGetImageTransferMode = (pfnCameraGetImageTransferMode)GetFunctionAddress(hSdkDll, "CameraGetImageTransferMode", typeof(pfnCameraGetImageTransferMode));
	CameraRequestTransferImage = (pfnCameraRequestTransferImage)GetFunctionAddress(hSdkDll, "CameraRequestTransferImage", typeof(pfnCameraRequestTransferImage));
	CameraResetTimestamp = (pfnCameraResetTimestamp)GetFunctionAddress(hSdkDll, "CameraResetTimestamp", typeof(pfnCameraResetTimestamp));
	...
	CameraGetAeWinVisible = (pfnCameraGetAeWinVisible)GetFunctionAddress(hSdkDll, "CameraGetAeWinVisible", typeof(pfnCameraGetAeWinVisible));
	...
	CameraSetAeExposureMode = (pfnCameraSetAeExposureMode)GetFunctionAddress(hSdkDll, "CameraSetAeExposureMode", typeof(pfnCameraSetAeExposureMode));
	CameraGetAeExposureMode = (pfnCameraGetAeExposureMode)GetFunctionAddress(hSdkDll, "CameraGetAeExposureMode", typeof(pfnCameraGetAeExposureMode));
	...
	CameraGetWbWinVisible = (pfnCameraGetWbWinVisible)GetFunctionAddress(hSdkDll, "CameraGetWbWinVisible", typeof(pfnCameraGetWbWinVisible));
	...
	__CameraSetCustomLut = (pfnCameraSetCustomLut)GetFunctionAddress(hSdkDll, "CameraSetCustomLut", typeof(pfnCameraSetCustomLut));
	__CameraGetCustomLut = (pfnCameraGetCustomLut)GetFunctionAddress(hSdkDll, "CameraGetCustomLut", typeof(pfnCameraGetCustomLut));
	...
	CameraGetFrameTime = (pfnCameraGetFrameTime)GetFunctionAddress(hSdkDll, "CameraGetFrameTime", typeof(pfnCameraGetFrameTime));
	...
	CameraSetResolution = (pfnCameraSetResolution)GetFunctionAddress(hSdkDll, "CameraSetResolution", typeof(pfnCameraSetResolution));
	CameraGetResolution = (pfnCameraGetResolution)GetFunctionAddress(hSdkDll, "CameraGetResolution", typeof(pfnCameraGetResolution));
	CameraSetResolutionEx = (pfnCameraSetResolutionEx)GetFunctionAddress(hSdkDll, "CameraSetResolutionEx", typeof(pfnCameraSetResolutionEx));
	CameraGetResolutionEx = (pfnCameraGetResolutionEx)GetFunctionAddress(hSdkDll, "CameraGetResolutionEx", typeof(pfnCameraGetResolutionEx));
	CameraGetCurResolution = (pfnCameraGetCurResolution)GetFunctionAddress(hSdkDll, "CameraGetCurResolution", typeof(pfnCameraGetCurResolution));
	CameraGetOutImageSize = (pfnCameraGetOutImageSize)GetFunctionAddress(hSdkDll, "CameraGetOutImageSize", typeof(pfnCameraGetOutImageSize));
	CameraSetBayerAlgMode = (pfnCameraSetBayerAlgMode)GetFunctionAddress(hSdkDll, "CameraSetBayerAlgMode", typeof(pfnCameraSetBayerAlgMode));
	CameraSetBayerAlgThreshold = (pfnCameraSetBayerAlgThreshold)GetFunctionAddress(hSdkDll, "CameraSetBayerAlgThreshold", typeof(pfnCameraSetBayerAlgThreshold));
	CameraGetBayerAlgMode = (pfnCameraGetBayerAlgMode)GetFunctionAddress(hSdkDll, "CameraGetBayerAlgMode", typeof(pfnCameraGetBayerAlgMode));
	...
	__CameraSaveImage = (pfnCameraSaveImage)GetFunctionAddress(hSdkDll, "CameraSaveImage", typeof(pfnCameraSaveImage));
	...
	CameraSetSensorOutPixelFormat = (pfnCameraSetSensorOutPixelFormat)GetFunctionAddress(hSdkDll, "CameraSetSensorOutPixelFormat", typeof(pfnCameraSetSensorOutPixelFormat));
	CameraGetSensorOutPixelFormat = (pfnCameraGetSensorOutPixelFormat)GetFunctionAddress(hSdkDll, "CameraGetSensorOutPixelFormat", typeof(pfnCameraGetSensorOutPixelFormat));
	...
	__CameraSaveParameterToFile = (pfnCameraSaveParameterToFile)GetFunctionAddress(hSdkDll, "CameraSaveParameterToFile", typeof(pfnCameraSaveParameterToFile));
	__CameraReadParameterFromFile = (pfnCameraReadParameterFromFile)GetFunctionAddress(hSdkDll, "CameraReadParameterFromFile", typeof(pfnCameraReadParameterFromFile));
	...
	__CameraWriteSN = (pfnCameraWriteSN)GetFunctionAddress(hSdkDll, "CameraWriteSN", typeof(pfnCameraWriteSN));
	__CameraReadSN = (pfnCameraReadSN)GetFunctionAddress(hSdkDll, "CameraReadSN", typeof(pfnCameraReadSN));
	__CameraSaveUserData = (pfnCameraSaveUserData)GetFunctionAddress(hSdkDll, "CameraSaveUserData", typeof(pfnCameraSaveUserData));
	__CameraLoadUserData = (pfnCameraLoadUserData)GetFunctionAddress(hSdkDll, "CameraLoadUserData", typeof(pfnCameraLoadUserData));
	__CameraGetFriendlyName = (pfnCameraGetFriendlyName)GetFunctionAddress(hSdkDll, "CameraGetFriendlyName", typeof(pfnCameraGetFriendlyName));
	__CameraSetFriendlyName = (pfnCameraSetFriendlyName)GetFunctionAddress(hSdkDll, "CameraSetFriendlyName", typeof(pfnCameraSetFriendlyName));
	__CameraSdkGetVersionString = (pfnCameraSdkGetVersionString)GetFunctionAddress(hSdkDll, "CameraSdkGetVersionString", typeof(pfnCameraSdkGetVersionString));
	CameraCheckFwUpdate = (pfnCameraCheckFwUpdate)GetFunctionAddress(hSdkDll, "CameraCheckFwUpdate", typeof(pfnCameraCheckFwUpdate));
	__CameraGetFirmwareVision = (pfnCameraGetFirmwareVision)GetFunctionAddress(hSdkDll, "CameraGetFirmwareVision", typeof(pfnCameraGetFirmwareVision));
	CameraGetDeviceType = (pfnCameraGetDeviceType)GetFunctionAddress(hSdkDll, "CameraGetDeviceType", typeof(pfnCameraGetDeviceType));
	__CameraGetInerfaceVersion = (pfnCameraGetInerfaceVersion)GetFunctionAddress(hSdkDll, "CameraGetInerfaceVersion", typeof(pfnCameraGetInerfaceVersion));
	CameraGetCurDevInfo = (pfnCameraGetCurDevInfo)GetFunctionAddress(hSdkDll, "CameraGetCurDevInfo", typeof(pfnCameraGetCurDevInfo));
	...
	CameraSetActivePage = (pfnCameraSetActivePage)GetFunctionAddress(hSdkDll, "CameraSetActivePage", typeof(pfnCameraSetActivePage));
	CameraCreateSettingPageEx = (pfnCameraCreateSettingPageEx)GetFunctionAddress(hSdkDll, "CameraCreateSettingPageEx", typeof(pfnCameraCreateSettingPageEx));
	...
	CameraSetTriggerFrameCount = (pfnCameraSetTriggerFrameCount)GetFunctionAddress(hSdkDll, "CameraSetTriggerFrameCount", typeof(pfnCameraSetTriggerFrameCount));
	CameraGetTriggerFrameCount = (pfnCameraGetTriggerFrameCount)GetFunctionAddress(hSdkDll, "CameraGetTriggerFrameCount", typeof(pfnCameraGetTriggerFrameCount));
	...
	CameraSetTriggerJitterTime = (pfnCameraSetTriggerJitterTime)GetFunctionAddress(hSdkDll, "CameraSetTriggerJitterTime", typeof(pfnCameraSetTriggerJitterTime));
	CameraGetTriggerJitterTime = (pfnCameraGetTriggerJitterTime)GetFunctionAddress(hSdkDll, "CameraGetTriggerJitterTime", typeof(pfnCameraGetTriggerJitterTime));
	CameraSetTriggerSignalType = (pfnCameraSetTriggerSignalType)GetFunctionAddress(hSdkDll, "CameraSetTriggerSignalType", typeof(pfnCameraSetTriggerSignalType));
	CameraGetTriggerSignalType = (pfnCameraGetTriggerSignalType)GetFunctionAddress(hSdkDll, "CameraGetTriggerSignalType", typeof(pfnCameraGetTriggerSignalType));
	...
	__CameraSetContrastLut = (pfnCameraSetContrastLut)GetFunctionAddress(hSdkDll, "CameraSetContrastLut", typeof(pfnCameraSetContrastLut));
	__CameraGetContrastLut = (pfnCameraGetContrastLut)GetFunctionAddress(hSdkDll, "CameraGetContrastLut", typeof(pfnCameraGetContrastLut));
	__CameraGetCurrentLut = (pfnCameraGetCurrentLut)GetFunctionAddress(hSdkDll, "CameraGetCurrentLut", typeof(pfnCameraGetCurrentLut));
    ...
    CameraSetOutputIOState = (pfnCameraSetOutputIOState)GetFunctionAddress(hSdkDll, "CameraSetOutputIOState", typeof(pfnCameraSetOutputIOState));
	...
	CameraSetOutputIOPWM = (pfnCameraSetOutputIOPWM)GetFunctionAddress(hSdkDll, "CameraSetOutputIOPWM", typeof(pfnCameraSetOutputIOPWM));
	CameraGetOutputIOPWM = (pfnCameraGetOutputIOPWM)GetFunctionAddress(hSdkDll, "CameraGetOutputIOPWM", typeof(pfnCameraGetOutputIOPWM));
	__CameraGigeGetIp = (pfnCameraGigeGetIp)GetFunctionAddress(hSdkDll, "CameraGigeGetIp", typeof(pfnCameraGigeGetIp));
	__CameraGigeSetIp = (pfnCameraGigeSetIp)GetFunctionAddress(hSdkDll, "CameraGigeSetIp", typeof(pfnCameraGigeSetIp));
}
}
}
